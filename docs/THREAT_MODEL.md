...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
| Secrets in metadata or errors                 | Key-based and pattern-based redaction before storage, fingerprinting, logging, or transport                  | New secret formats may need new patterns; applications must avoid sending unnecessary data                            |
