...
threshold, and never reads response bodies or headers. The Express error handler marks thrown
errors so a response generated by the normal error path is not captured a second time.
